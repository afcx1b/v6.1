...
user = User()
user.username = 'admin'
user.first_name = 'Luis Alfonso'
user.last_name = 'Moncayo Pulgarin'
user.email = 'mpla052281@gmail.com'
...
company = Company()
company.name = 'MOBECAM SAS'
company.ruc = '1793205009001'
company.address = 'Av. 6 de Diciembre y Whymper, Edificio Cosideco Of. 202, Quito, Ecuador'
company.mobile = '+593983205843'
company.website = 'https://mobecamsas.com'
company.save()
