...
from core.pos.models import Sale, Purchase
from core.reports.forms import ReportForm


class ReportSaleView(LoginRequiredMixin, ValidatePermissionRequiredMixin, FormView):
...
class ReportPurchaseView(LoginRequiredMixin, ValidatePermissionRequiredMixin, FormView):
