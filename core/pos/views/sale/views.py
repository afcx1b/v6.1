...
class SaleListView(ExistsCompanyMixin, LoginRequiredMixin, ValidatePermissionRequiredMixin, FormView):
...
class SaleCreateView(ExistsCompanyMixin, LoginRequiredMixin, ValidatePermissionRequiredMixin, CreateView):
    model = Sale
    form_class = SaleForm
...
class SaleUpdateView(ExistsCompanyMixin, LoginRequiredMixin, ValidatePermissionRequiredMixin, UpdateView):
    model = Sale
    form_class = SaleForm
    template_name = 'sale/create.html'
    success_url = reverse_lazy('sale_list')
...
class SaleDeleteView(ExistsCompanyMixin, LoginRequiredMixin, ValidatePermissionRequiredMixin, DeleteView):
    model = Sale
